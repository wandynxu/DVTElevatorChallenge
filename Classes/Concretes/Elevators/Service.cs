...
namespace Building.Classes.Concretes.Elevators
{
    ...
    {
        private string _speed = ElevatorSpeed.Normal.ToString();
        private const int _passengerLimit = 4;
        private const double _weightLimit = 80.5;
        private const int _numberOfElevators = (int)ElevatorTypes.Service;
        ...
        public override string Speed { get => Speed; set => _speed = value; }
